...
namespace Sensei.AspNet.Tests.FakeServer.Entities
{
    public class ProductAlt2 : BaseModel
    {
        ...
        [CanSort(false)] [CanFilter(false)] public string Name { get; set; }

        [CanSort(false)] [CanFilter(false)] public bool Enabled { get; set; }
        ...
        [CanInclude(false)] public Category CategoryAlt { get; set; }
